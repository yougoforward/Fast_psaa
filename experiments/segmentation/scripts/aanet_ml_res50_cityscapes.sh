...
#train
python train_ml.py --dataset cityscapes --batch-size 8 \
    --model aanet_ml --aux --dilated --base-size 1024 --crop-size 768 \
    --backbone resnet50 --checkname aanet_ml_res50_cityscapes

#test [single-scale]
python test.py --dataset cityscapes --batch-size 8 \
    --model aanet_ml --aux --dilated --base-size 2048 --crop-size 768 \
    --backbone resnet50 --resume runs/cityscapes/aanet_ml/aanet_ml_res50_cityscapes/model_best.pth.tar \
    --split val --mode testval

#test [multi-scale]
python test.py --dataset cityscapes --batch-size 8 \
    --model aanet_ml --aux --dilated --base-size 2048 --crop-size 1024 \
    --backbone resnet50 --resume runs/cityscapes/aanet_ml/aanet_ml_res50_cityscapes/model_best.pth.tar \
