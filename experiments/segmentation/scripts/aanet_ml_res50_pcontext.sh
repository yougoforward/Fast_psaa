...
#train
python train_ml.py --dataset pcontext \
    --model aanet_ml --dilated --base-size 608 --crop-size 576 \
    --backbone resnet50 --checkname aanet_ml_res50_pcontext

#test [single-scale]
python test.py --dataset pcontext \
    --model aanet_ml --dilated --base-size 608 --crop-size 576 \
    --backbone resnet50 --resume runs/pcontext/aanet_ml/aanet_ml_res50_pcontext/model_best.pth.tar \
